    ...
    return (
        <Table className="custom-table" aria-label="Example static collection table">
            ...
            <TableBody>
                ...
                <TableRow>
                    <p>nextjs-toploader</p>
                    <p>
                        Top loading indicator for next.js (It will see, when changing page and initial load of website)
                    </p>
                </TableRow>
                <TableRow>
