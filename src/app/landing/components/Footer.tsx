            ...
            <div className="container py-16">
                <div className="relative grid items-center overflow-hidden rounded-xl bg-primary/5 py-0 lg:grid-cols-3">
                    ...
                    <div className="-mt-8 hidden h-96 rotate-[15deg] lg:inline">
                        <Image src={mobileHeroLandingImg} alt="mobile-landing" className="inline dark:hidden" />
                        <Image src={mobileHeroDarkLandingImg} alt="mobile-landing" className="hidden dark:inline" />
                    </div>
                </div>
