...
const AreaNegativeValueChart = () => {
    ...
    const chartOptions = useMemo((): ApexOptions => {
        return {
            ...
            yaxis: {
                labels: {
                    formatter: function (value) {
                        return (value < 0 ? "-" : "") + currencyHelper.sign + Math.abs(value) + "K";
                    },
                },
            },
            chart: {
            ...
            colors: [primaryColor, "#FFC470", "#67C6E3", "#FFC700"],
            fill: {
                type: "solid",
                opacity: 0.6,
            },
    ...
    return <ApexChart options={chartOptions} type={"area"} height={380} series={chartOptions.series} />;
};

export default AreaNegativeValueChart;
