        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-2">
            ...
            <Card className="bg-base-100">
                <CardBody>
                    ...
                    <div className="mt-1 flex flex-wrap gap-4">
                        <RadialProgress value={72} aria-label="Radial progress">
                            72%
                        </RadialProgress>
                        <RadialProgress
                            value={72}
            ...
            <Card className="bg-base-100">
                <CardBody>
                    ...
                    <div className="mt-1 flex flex-wrap gap-4">
                        <RadialProgress value={72} color="primary" aria-label="Radial progress">
                            72%
                        </RadialProgress>
                        <RadialProgress value={72} color="secondary" aria-label="Radial progress">
                            65%
                        </RadialProgress>
                        <RadialProgress value={72} color="success" aria-label="Radial progress">
                            85%
                        </RadialProgress>
                        <RadialProgress value={72} color="info" aria-label="Radial progress">
                            57%
                        </RadialProgress>
                        <RadialProgress value={72} color="warning" aria-label="Radial progress">
                            20%
                        </RadialProgress>
                        <RadialProgress value={72} color="error" aria-label="Radial progress">
                            40%
                        </RadialProgress>
                    </div>
                </CardBody>
