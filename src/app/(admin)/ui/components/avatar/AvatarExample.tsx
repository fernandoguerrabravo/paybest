...
import { Avatar, AvatarGroup, Card, CardBody, CardTitle, maskClassesFn } from "@/components/daisyui";
            ...
            <Card className="bg-base-100">
                <CardBody>
                    ...
                    <div className="mt-1 space-y-1">
                        <Avatar alt="Avatar" src={avatar1.src} innerClassName={"rounded bg-base-content/10"} />
                    </div>
                </CardBody>
            </Card>
            <Card className="bg-base-100">
