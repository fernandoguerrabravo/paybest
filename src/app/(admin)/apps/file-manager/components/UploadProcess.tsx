    ...
    return (
        <div>
            ...
            <div className="mt-1 flex items-center justify-between">
                ...
                <span className="text-xs text-base-content/70">{stringHelper.convertToStorageUnits(size)}</span>
            </div>
            <Progress
