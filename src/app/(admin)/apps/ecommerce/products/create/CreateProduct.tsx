...
import { useCreateEcommerceProduct } from "./use-create-product";

const CreateEcommerceProduct = () => {
    const { control, productCategories, handleChangeImage, handleCancel, onSubmit, isLoading } =
        useCreateEcommerceProduct();
