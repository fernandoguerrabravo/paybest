...
import { useEditEcommerceCustomer } from "./use-edit-customer";

const EditEcommerceCustomer = () => {
    const {
        control,
        customerImage,
                    ...
                    <CardBody>
                        ...
                        <div className="mt-1">
                            <div className="filepond-file-upload">
                                <FileUploader
                                    files={[...(customerImage ? [customerImage] : [])]}
