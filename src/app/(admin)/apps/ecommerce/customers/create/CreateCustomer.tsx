...
import { useCreateEcommerceCustomer } from "./use-create-customer";

const CreateEcommerceCustomer = () => {
    const { control, handleChangeImage, handleCancel, onSubmit, isLoading } = useCreateEcommerceCustomer();
    return (
        <form>
                    ...
                    <CardBody className="gap-0">
                        ...
                        <div className="mt-1 grid gap-5">
                            <div className="grid grid-cols-1 gap-5 gap-y-3 md:grid-cols-2">
                                <div>
                                    <FormLabel title={"Street Address"} htmlFor="address"></FormLabel>
                                    <FormInput
                                        className="w-full border-0 focus:outline-0"
                                        control={control}
                                        size="sm"
                                ...
                                <div>
                                    <FormLabel title={"Postal Code"} htmlFor="postalCode"></FormLabel>
                                    <FormInput
                                        className="w-full border-0 focus:outline-0"
                                        control={control}
                                        size="sm"
...
export { CreateEcommerceCustomer };
