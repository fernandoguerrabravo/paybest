...
import { useCreateEcommerceSeller } from "./use-create-seller";

const CreateEcommerceSeller = () => {
    const { control, handleCancel, onSubmit, isLoading, handleChangeImage } = useCreateEcommerceSeller();
    return (
        <form>
