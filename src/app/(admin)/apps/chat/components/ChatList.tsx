...
import { Badge, Button, Card, CardBody, Input, Tooltip, maskClassesFn } from "@/components/daisyui";
                ...
                <div className="flex justify-between">
                    ...
                    {lastMessage && (
                        <span className="text-xs text-base-content/60">
                            {dateHelper.formatted(lastMessage.sendAt, { format: "hh:mm A" })}
                        </span>
                    )}
                </div>
        ...
        <Card className="bg-base-100">
            <CardBody>
                <div className="flex items-center gap-3">
                    ...
                    <Tooltip message="New Contact" aria-label="New contact">
                        <Button
                            color={"ghost"}
